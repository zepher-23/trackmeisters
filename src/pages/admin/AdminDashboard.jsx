...
const AdminDashboard = ({ onLogout }) => {
      ...
      if (modalType === "blogs" && formData.sections) {
        ...
        formData.sections = formData.sections.filter((section) => {
          if (section.type === "text") {
            ...
            const hasTitle =
              section.sectionTitle && section.sectionTitle.trim().length > 0;
            return hasContent || hasTitle;
          }
          if (section.type === "image")
            return section.url && section.url.trim().length > 0;
          if (section.type === "video")
            return section.youtubeId && section.youtubeId.trim().length > 0;
              ...
              try {
                await fetch('/api/submit-form', {
                  ...
                  body: JSON.stringify({
                    ...
                    data: {
                      name: formData.contactName || 'User',
                ...
                await fetch('/api/submit-form', {
                  ...
                  body: JSON.stringify({
                    ...
                    data: {
                      ...
                      email: formData.contactEmail,
                      title: formData.title,
                      rejectionReason: formData.rejectionReason || 'Your listing did not meet our guidelines.'
                    }
                  })
                });
    ...
    try {
      ...
      if (section === "media") {
        ...
        if (itemToDelete) {
          ...
          if (publicId) {
            const resourceType =
              itemToDelete.type === "video" ? "video" : "image";
      ...
      if (modalType === "media" && field === "thumbnail") {
        await new Promise((resolve) => {
          ...
          img.onload = () => {
            ...
            if (aspect >= 1.75)
              detectedSize = "wide"; // Landscape
            else if (aspect <= 0.6)
              detectedSize = "tall"; // Portrait
  ...
  const handleBatchUpload = async (files) => {
      ...
      try {
        ...
        if (isFirebaseReady()) {
          ...
          setData((prev) => ({
            ...
            media: [
              ...prev.media,
              { ...newMedia, id: Date.now().toString() + Math.random() },
            ],
          }));
        }
        successCount++;
    ...
    if (errors.length > 0) {
      setMediaUploadError(
        `Uploaded ${successCount}/${files.length}. Issues: ${errors.join("; ")}`,
      );
    }
  };
  ...
  const handleGalleryUpload = async (e) => {
    ...
    try {
      ...
      const uploadPromises = files.map((file) =>
        uploadToCloudinary(file, "classifieds"),
      );
        ...
        <AnimatePresence>
          {modalOpen && (
            <div
              ...
              onClick={closeModal}
              style={{ zIndex: 200, position: "fixed", padding: 0 }}
            >
              <motion.div
                  ...
                  {modalType === "events" && (
                    <>
                      ...
                      <div className="admin-form-group">
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              newStatus === "completed" &&
                              !newFormData.classResults &&
                              formData.classes
                            ) {
                              const initialResults = {};
                              formData.classes.forEach((cls) => {
                                if (cls.name) {
                                  initialResults[cls.name] = [
                                    { pos: "1", driver: "", car: "", time: "" },
                                  ];
                                }
                              });
                          ...
                          <div style={{ marginTop: "8px" }}>
                            ...
                            {formData.classes.map((cls, clsIdx) => (
                              ...
                              >
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      const currentResults = {
                                        ...(formData.classResults || {}),
                                      };
                                      const classRows = [
                                        ...(currentResults[cls.name] || []),
                                      ];
                                      classRows.push({
                                        pos: classRows.length + 1,
                                        driver: "",
                                        car: "",
                                        time: "",
                                      });
                                ...
                                {(formData.classResults?.[cls.name] || []).map(
                                  (row, rowIdx) => (
                                    <div
                                      key={rowIdx}
                                      style={{
                      ...
                      <div className="admin-form-group">
                        ...
                        >
                          Add participation classes for this event (e.g., Street
                          Class, GT3)
                        </p>
                  ...
                  {modalType === "classifieds" && (
                    <>
                      ...
                      <div className="admin-form-group">
                        ...
                        >
                          Add multiple images for the gallery. First image will
                          be used if Featured Image is not set.
                        </p>
                        <div
                          style={{
                            display: "grid",
                      ...
                      {formData.status === "rejected" && (
                        <div className="admin-form-group">
                          ...
                          <textarea
                            ...
                            rows={3}
                            placeholder="Please explain why the listing is rejected..."
                            style={{
                              width: "100%",
                              padding: "12px",
                              background: "#27272a",
                  ...
                  {editItem && (
                    <button
                      ...
                      onClick={() => {
                        ...
                        closeModal();
                        setTimeout(
                          () => setDeletingItem({ section, id: itemId }),
                          200,
            ...
            >
              ...
              >
                <div className="admin-modal-header">
                  ...
                  <button onClick={() => setDriverFormVisible(false)}>
                    <X size={24} />
                  </button>
                </div>
                <div
                ...
                >
                  ...
                  <div
                    className="driver-form-image"
                    onClick={() => driverImageRef.current?.click()}
                  ...
                  <input
                    ...
                    value={driverForm.subtitle}
                    onChange={(e) =>
                      setDriverForm({ ...driverForm, subtitle: e.target.value })
                    }
                  />
                  <select
                    className="admin-form-input"
                    ...
                    onChange={(e) =>
                      setDriverForm({ ...driverForm, rank: e.target.value })
                    }
                  >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setDriverForm({ ...driverForm, car: e.target.value })
                    }
                  />
                  ...
                  <div style={{ display: "flex", gap: "10px" }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setDriverForm({
                          ...driverForm,
                          podiums: parseInt(e.target.value) || 0,
                        })
                      }
                    />
                    <input
                      className="admin-form-input"
                      placeholder="Fast Laps"
                      type="number"
                      value={driverForm.fastLaps}
                      onChange={(e) =>
                        setDriverForm({
                          ...driverForm,
                          fastLaps: parseInt(e.target.value) || 0,
                        })
                      }
                    />
                  </div>
                ...
                <div className="admin-modal-footer">
                  <button
                    ...
                    onClick={() => setDriverFormVisible(false)}
                  >
                    Cancel
                  </button>
                  <button
      ...
      {!isFirebaseReady() && (
        ...
        >
          ...
          >
            <AlertCircle size={20} />
            <span>
              Firebase not configured. Running in local mode - changes won't
              persist.
            </span>
          </div>
        </div>
                ...
                <tr key={event.id}>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <option
                        value="completed"
                        style={{ background: "#18181b", color: "#22c55e" }}
                      >
                        Completed
                      </option>
                      <option
                        value="cancelled"
                        style={{ background: "#18181b", color: "#ef4444" }}
                      >
                        Cancelled
                      </option>
                    </select>
        ...
        <div className="youtube-embed-section">
          <button
            ...
            style={{
              width: "100%",
              justifyContent: "center",
              marginBottom: showYoutubeInput ? "12px" : 0,
            }}
          >
              ...
              <div className="media-item-visual">
                ...
                <div className="media-item-overlay">
                  ...
                  <div className="media-overlay-info">
                    {item.duration && (
                      <span className="media-meta">{item.duration}</span>
                    )}
        ...
        <tbody>
          {(data.documents || []).map((doc) => (
            <tr key={doc.id}>
              ...
              <td>
                <span className="admin-badge">{doc.category}</span>
              </td>
              <td>
                <a
                  href={doc.fileUrl}
              ...
              <td className="admin-table-actions">
                {deletingItem?.section === "documents" &&
                  ...
                  <>
                    <button
                      className="admin-btn admin-btn-sm admin-btn-secondary"
                      onClick={() => openModal("documents", doc)}
                    >
                      <Edit2 size={14} />
                    </button>
                    <button
                      className="admin-btn admin-btn-sm admin-btn-danger"
                      onClick={() =>
                        setDeletingItem({ section: "documents", id: doc.id })
                      }
                    >
                      <Trash2 size={14} />
                    </button>
  ...
  const renderClassifieds = () => {
    const allListings = data.classifieds || [];
    ...
    return (
      <div className="admin-card">
        <div className="admin-card-header">
          <h3 className="admin-card-title">Classifieds</h3>
          <div style={{ display: "flex", gap: "10px" }}>
            <button
              className="admin-btn admin-btn-secondary"
              onClick={() => {
            ...
            <button
              className="admin-btn admin-btn-primary"
              onClick={() => {
                setFormData({ type: "car", isPublished: false, images: [] });
                setModalType("classifieds");
                setEditItem(null);
                setModalOpen(true);
              }}
        ...
        >
          {[
            ...
            { key: "car", label: "Cars", count: carCount },
            { key: "product", label: "Products", count: productCount },
          ].map((tab) => (
            <button
              key={tab.key}
              onClick={() => setClassifiedsFilter(tab.key)}
              style={{
                padding: "8px 16px",
                borderRadius: "6px",
                border: "none",
                background:
                  classifiedsFilter === tab.key
                    ? "var(--admin-primary, #ef4444)"
        ...
        <table className="admin-table">
          <thead>
            <tr>
              ...
              <th>Title</th>
              <th>Price</th>
              {classifiedsFilter !== "product" && <th>Year</th>}
              {classifiedsFilter !== "product" && <th>Transmission</th>}
              <th>Status</th>
              <th>Actions</th>
            </tr>
          </thead>
            ...
            {filteredListings.map((listing) => (
              <tr key={listing.id} style={{ position: "relative" }}>
                ...
                <td>
                  ...
                  >
                    {listing.status
                      ? (listing.status.includes('pending') ? 'Pending Review' : listing.status.replace("_", " "))
                ...
                <td className="admin-table-actions">
                  {deletingItem?.section === "classifieds" &&
                    ...
                    <>
                      <button
                        className="admin-btn admin-btn-sm admin-btn-secondary"
                        onClick={() => openModal("classifieds", listing)}
                      >
                        <Edit2 size={14} />
                      </button>
                      <button
        ...
        {filteredListings.length === 0 && (
          <div
            style={{ textAlign: "center", padding: "40px", color: "#71717a" }}
          >
            {classifiedsFilter === "product" ? (
              <Package
                size={48}
        ...
        >
          <button
            ...
            style={{
              ...
              transition: "all 0.2s ease",
              background:
                newsletterTab === "newsletter" ? "#ef4444" : "transparent",
              color:
                newsletterTab === "newsletter"
                  ? "white"
          ...
          <button
            ...
            style={{
              ...
              color:
                newsletterTab === "press" ? "white" : "rgba(255,255,255,0.6)",
              boxShadow:
                newsletterTab === "press"
                  ? "0 2px 4px rgba(0,0,0,0.2)"
                  : "none",
  ...
  const renderImageUploadField = (label, field, currentValue) => {
    ...
    if (modalType !== "media") {
      if (field === "image") instruction = "Rec: 1200x800px (Max 5MB)";
        ...
        instruction = "Rec: 1920x1080px (Max 5MB)";
      else if (field === "logo") instruction = "Rec: 400px PNG (Max 2MB)";
      else if (field === "featuredImage" || field === "images")
        instruction = "Rec: 1200x900px (Max 5MB)";
                ...
                >
                  ...
                  <div className="admin-form-group" style={{ marginBottom: 0 }}>
                    ...
                    <input
                      ...
                      value={formData.fastestLap || ""}
                      onChange={(e) =>
                        setFormData({ ...formData, fastestLap: e.target.value })
                      }
                      placeholder="e.g. 1:14.200"
                    />
                  </div>
          ...
          <>
            ...
            <div className="admin-form-group">
              ...
              <input
                ...
                placeholder={
                  formData.type === "product"
                    ? "e.g., Akrapovic Exhaust"
                    : "e.g., 2023 Porsche 911 GT3"
                }
              />
            </div>
            ...
            <div className="admin-form-group">
              ...
              >
                Add multiple images for the gallery. First image will be used if
